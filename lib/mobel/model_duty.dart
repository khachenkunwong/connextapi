...
class Profile {
    ...
    factory Profile.fromJson(Map<String, dynamic> json) => Profile(
        duty: json["duty"] == null ? null : List<Duty>.from(json["duty"].map((x) => Duty.fromJson(x))),
    );
...
class Duty {
    ...
    factory Duty.fromJson(Map<String, dynamic> json) => Duty(
        ...
        duty: json["_duty"] == null ? null : List<DutyElement>.from(json["_duty"].map((x) => DutyElement.fromJson(x))),
...
class DutyElement {
    ...
    factory DutyElement.fromJson(Map<String, dynamic> json) => DutyElement(
        id: json["_id"] == null ? null : json["_id"],
